...
export default class ErrorBoundary extends Component<Props, State> {
    ...
    public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
        console.error("Uncaught React Error in Delivery App:", error, errorInfo);
    }
            ...
            return (
                <div className="min-h-[100dvh] bg-slate-100 flex items-center justify-center p-4">
                    <div className="bg-white rounded-[32px] p-6 max-w-sm w-full shadow-2xl border border-slate-200/80 text-center space-y-4">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-slate-800">Interrupción en la App de Conductor</h2>
                            <p className="text-xs text-slate-500 mt-2 font-medium leading-relaxed">
                                Ocurrió una desconexión o error inesperado al desplegar esta sección. Puedes recargar la pantalla o volver al inicio del radar.
                            </p>
                        </div>
                        {this.state.error && (
                        ...
                        <div className="space-y-2 pt-2">
                            ...
                            >
                                <Home className="w-4 h-4" /> Ir al Radar
                            </button>
                        </div>
                    </div>
                </div>
