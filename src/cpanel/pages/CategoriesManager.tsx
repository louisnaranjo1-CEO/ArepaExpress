        ...
        <div className="space-y-8 pb-32 max-w-7xl mx-auto px-4 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm overflow-hidden relative group">
                ...
                <div className="flex items-center gap-3 relative z-10">
                    ...
                    <button onClick={() => handleOpenModal('create')} className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-2xl transition-all font-black shadow-lg hover:shadow-indigo-200 active:scale-95">
            ...
            <div className="relative max-w-xl mx-auto">
                ...
                <input
                    ...
                    className="w-full pl-14 pr-4 py-4 bg-white border border-slate-200 rounded-3xl outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50 transition-all font-bold text-slate-700 shadow-lg shadow-slate-100"
                />
            </div>
                        ...
                        <div className="flex items-center justify-between p-6 bg-slate-50/50">
                            <div className="flex items-center gap-5">
                                <button
                                    ...
                                    className="p-1.5 hover:bg-white rounded-xl transition-all text-slate-400 hover:text-indigo-600"
                                >
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-black bg-indigo-100 text-indigo-600 px-2 py-0.5 rounded-full uppercase tracking-widest">Sector Principal</span>
                                    </div>
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-600 rounded-xl transition-all font-black text-xs"
                                >
                                    <Plus className="w-4 h-4" />
                                    Agregar Subcategoría
                                </button>
                                <div className="w-px h-8 bg-slate-200 mx-2"></div>
                                <button onClick={() => handleOpenModal('edit', sector)} className="p-3 text-slate-400 hover:text-indigo-600 hover:bg-white rounded-xl transition-all"><Edit3 className="w-5 h-5" /></button>
                                            ...
                                            {categories.filter(sub => sub.parentId === sector.id).map(sub => (
                                                <div key={sub.id} className="group p-4 bg-slate-50/50 hover:bg-white rounded-2xl border border-transparent hover:border-slate-100 hover:shadow-lg transition-all flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <button onClick={() => handleOpenModal('edit', sub)} className="p-2 text-slate-400 hover:text-indigo-600"><Edit3 className="w-4 h-4" /></button>
                                ...
                                <div className="flex items-center justify-between mb-8">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-indigo-50 rounded-2xl flex items-center justify-center">
                                            {modalMode === 'create' ? <FolderPlus className="w-6 h-6 text-indigo-600" /> : <FileEdit className="w-6 h-6 text-indigo-600" />}
                                        </div>
                                        <div>
                                ...
                                <form onSubmit={handleSave} className="space-y-6">
                                    ...
                                    <div className="flex flex-col items-center gap-4 mb-4">
                                        <div
                                            ...
                                            className="w-32 h-32 rounded-3xl bg-slate-50 border-2 border-dashed border-slate-200 flex items-center justify-center overflow-hidden relative group cursor-pointer hover:border-indigo-400 transition-all"
                                        >
                                            {photoPreview ? (
                                                <img src={photoPreview} className="w-full h-full object-cover" />
                                            ) : (
                                                <div className="flex flex-col items-center gap-2">
                                                    <Camera className="w-8 h-8 text-slate-300 group-hover:text-indigo-600" />
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white px-6 py-4 rounded-2xl outline-none transition-all font-black text-slate-700"
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="space-y-1.5">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white px-6 py-3 rounded-2xl outline-none transition-all font-black text-center text-xl"
                                                    placeholder="📁"
                                                />
                                            </div>
                                            <div className="space-y-1.5">
                                                ...
                                                <select
                                                    ...
                                                    className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white px-4 py-3 rounded-2xl outline-none transition-all font-bold text-slate-600 text-sm"
                                                >
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white px-6 py-3 rounded-2xl outline-none transition-all font-bold text-slate-600 h-24 resize-none"
                                    ...
                                    <div className="flex gap-3 pt-4">
                                        ...
                                        <button
                                            ...
                                            className="flex-[2] bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-2xl font-black shadow-xl hover:shadow-indigo-200 transition-all flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50 disabled:scale-100"
                                        >
