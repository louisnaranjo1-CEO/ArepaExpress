  ...
  return (
    <nav className="relative z-50 bg-white border-t border-slate-100 pb-safe shrink-0">
      <div className="flex items-center justify-around px-2 py-3">
        ...
        <Link to="/taxi" className="relative flex flex-col items-center justify-center flex-1 group">
          ...
          {totalItems > 0 && (
            <span className="absolute top-0 right-[20%] -mt-1 flex h-5 w-5 items-center justify-center rounded-full bg-accent text-[10px] font-black text-white ring-2 ring-white shadow-md">
              {totalItems}
            </span>
          )}
