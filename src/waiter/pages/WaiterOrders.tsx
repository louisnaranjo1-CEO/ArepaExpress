            ...
            <header className="px-5 py-6 bg-white/80 backdrop-blur-md sticky top-0 z-30 border-b border-slate-50">
                ...
                <div className="flex gap-2 mt-4">
                    <button
                        ...
                        className={`px-4 py-2 rounded-xl text-xs font-black transition-all ${filter === 'active' ? 'bg-primary text-slate-900 shadow-lg shadow-primary/20' : 'bg-slate-100 text-slate-400'}`}
                    >
                        ACTIVOS
                    </button>
                    <button
                        onClick={() => setFilter('history')}
                        className={`px-4 py-2 rounded-xl text-xs font-black transition-all ${filter === 'history' ? 'bg-primary text-slate-900 shadow-lg shadow-primary/20' : 'bg-slate-100 text-slate-400'}`}
                    >
                        HISTORIAL
                    </button>
                </div>
